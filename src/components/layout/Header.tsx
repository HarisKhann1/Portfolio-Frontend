...
import logo from '../../assets/pictures/haris_khan_portfolio_picture.jpg';
  ...
  return (
    ...
    ">
        ...
        <div className='flex items-center gap-2'>
            <img src={logo} alt="Haris Khan" className="w-12 h-12 rounded-full object-cover" />
            <h1 className="text-xl font-bold">Haris Khan</h1>
        </div>
        {/* middle */}
        <div>
                        ...
                        return (
                            <li key={link.name}>
                                <NavLink to={link.link} 
                                        className={({ isActive }) =>
                                            `hover:underline hover:underline-offset-4 transition-all duration-300 ease-in-out text-black dark:text-white ${
                                              isActive ? 'dark:text-white' : 'text-gray-700'
                                            }`
                                        }
                                >
                                    {link.name}
        ...
        <div>
            <button 
                className='rounded-3xl border px-4 py-1 text-sm cursor-pointer'
